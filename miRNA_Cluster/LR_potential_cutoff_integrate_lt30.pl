...
sub main{
	...
	foreach my $methy_data (@methy_data) {
		...
		my $methy_file="$methy_data"."_methylation_lt30.txt";
		push @methy_file,$methy_file;
		push @methy_type,"lost";
	}

#my $dir="/home/qpzhang/Ge50";
	my @filein1=("dnds_value_final_lt30.txt",
				 "all.negative.lt30.genome_pos.unique.num.expand_for_cut.fa.title2.dG","all.negative.lt30.genome_pos.unique.num.expand_for_cut.fa.title2.out.negative",
				 "blastn_sRNA_neglog10evalue.txt","all.negative.lt30.genome_pos.unique.phast.all.ID.pro",
				"SNP_coverage_stat_v5_lt30.txt.pro",
				"GC_percent_lt30.txt",
				"EST_coverage_stat_v5_lt30.txt.pro","all.negative.lt30.genome_pos.unique.num.unigene");
...
sub dataset_getTerm2LR{
	...
	my $filein="./NetworkIntegrationMi3/evidence2lr_$dataset.txt";
