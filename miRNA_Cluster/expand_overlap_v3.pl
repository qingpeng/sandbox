...
# 取最终的两端坐标
# 2007-9-20 13:01
# more test.in|sort -k 2,2nr -k 4,4 -k 5,5 -k 6,6n
...
#                print LOG "$line\n";
#            }
                $ref_new_lines = &get_pos(\@lines);
                @new_lines = @{$ref_new_lines};
...
#                print LOG "newline:$k\n$new_line\n";
            ...
            if ($have_overlap == 0) {
                push @new_lines,$line; # 如果与上面行都没有overlap
#                print LOG "newline_new:\n $line\n";
            }
    }
#                foreach my $line (@new_lines) {
#                print LOG "bbb$line\n";
